...
function Profile() {
  ...
  return (
    <div style={{ backgroundColor: "#FDFFEA", minHeight: "100vh", padding: "24px", maxWidth: "700px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
          <div>
            ...
            <input
              ...
              placeholder="Jane"
              style={{ display: "block", width: "100%", marginTop: "4px", padding: "8px 12px", borderRadius: "8px", border: "1px solid #d1d5db", fontSize: "14px", boxSizing: "border-box" }}
            />
          </div>
          <div>
            <label style={{ fontSize: "13px", color: "#374151", fontWeight: 500 }}>
      ...
      >
        ...
        <textarea
          ...
          rows={5}
          style={{ display: "block", width: "100%", padding: "8px 12px", borderRadius: "8px", border: "1px solid #d1d5db", fontSize: "14px", resize: "vertical", boxSizing: "border-box" }}
        />
      </div>
